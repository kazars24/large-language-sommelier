...
class Settings(BaseSettings):
    ...
    PROMPT_TEMPLATE: str = (
        ...
        "Предлагай максимум три варианта. Обязательно обоснуй, почему твои предложения подходят под запрос пользователя.\n"
        "Обязательно укажи название и стоимость вина.\n"
